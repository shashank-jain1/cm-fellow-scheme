...
public sealed class UpdateTrainingScheduleCommandValidator : AbstractValidator<UpdateTrainingScheduleCommand>
{
    public UpdateTrainingScheduleCommandValidator()
    {
        RuleFor(x => x.TrainingScheduleId)
            .GreaterThan(0).WithMessage("Training Schedule ID is required.");

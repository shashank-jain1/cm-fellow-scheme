...
internal static class StartupSeedData
{
    public static async Task RunAllAsync(WebApplication app)
    {
        ...
        using (IServiceScope locationScope = app.Services.CreateScope())
        {
            await LocationSeedData.SeedAsync(locationScope.ServiceProvider.GetRequiredService<IMastersCommandDbContext>());
        }
    }
    ...
    private static async Task SeedLookupMasters(WebApplication app)
    {
        using IServiceScope scope = app.Services.CreateScope();
    ...
    private static async Task SeedModuleMaster(WebApplication app)
    {
        using IServiceScope scope = app.Services.CreateScope();
        IRegistrationCommandDbContext dbContext = scope.ServiceProvider
            .GetRequiredService<IRegistrationCommandDbContext>();
    ...
    private static async Task SeedAdminUserRole(WebApplication app)
    {
        using IServiceScope scope = app.Services.CreateScope();
        IRegistrationCommandDbContext dbContext = scope.ServiceProvider
            .GetRequiredService<IRegistrationCommandDbContext>();
    ...
    private static async Task SeedLeaveTypes(WebApplication app)
    {
        using IServiceScope scope = app.Services.CreateScope();
        IRegistrationCommandDbContext dbContext = scope.ServiceProvider
            .GetRequiredService<IRegistrationCommandDbContext>();
    ...
    private static async Task SeedTicketCategories(WebApplication app)
    {
        using IServiceScope scope = app.Services.CreateScope();
        IRegistrationCommandDbContext dbContext = scope.ServiceProvider
            .GetRequiredService<IRegistrationCommandDbContext>();

...
public class EscalateTicketValidationTests
{
    private readonly EscalateTicketCommandValidator _validator = new();

    [Fact]
    public void Should_Have_Error_When_TicketId_Is_Zero()
    {
        var command = new EscalateTicketCommand { TicketId = 0 };
    ...
    {
        var command = new EscalateTicketCommand { ActionBy = "" };
    ...
    {
        var command = new EscalateTicketCommand { ActionBy = new string('a', 201) };
    ...
    {
        var command = new EscalateTicketCommand { Remarks = "" };
    ...
    {
        var command = new EscalateTicketCommand { Remarks = new string('a', 2001) };
    ...
    {
        var command = new EscalateTicketCommand
        {
            TicketId = 1,
            ActionBy = "admin",
            Remarks = "Escalating to senior support team."
        };

...
public class CreateDivisionCommandValidatorTests
{
    private readonly CreateDivisionCommandValidator _validator = new();
    ...
    [Fact]
    public void Should_Not_Have_Error_When_DivisionCode_Is_Empty()
    {
        var command = new CreateDivisionCommand
        {
            StateId = 1,

...
public class CreateBlockCommandValidatorTests
{
    private readonly CreateBlockCommandValidator _validator = new();
    ...
    [Fact]
    public void Should_Not_Have_Error_When_BlockCode_Is_Empty()
    {
        var command = new CreateBlockCommand
        {
            DistrictId = 1,
        ...
        var result = _validator.TestValidate(command);
        result.ShouldNotHaveValidationErrorFor(x => x.BlockCode);
    }
